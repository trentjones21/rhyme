...
export const LEVELS = [
  ...
  L("3-06", 3, "Storm Season", {
    ...
    start: { minerals: 26, food: 14, crew: 5 },
    deposits: [{ x: 1, y: 6 }, { x: 8, y: 11 }],
    mechanics: { kitchenChain: true, flares: { first: 22, interval: 16, damage: 9, telegraph: 2.4 } },
    allowed: ["corridor", "garden", "extractor", "kitchen", "weapons", "quarters", "shield"],
    waves: { first: 26, interval: 22, count: (n) => 1 + n, hp: (n) => 24 + n * 10, max: 3 },
    eatRate: 0.016,
    win: { surviveWaves: 3 },
    par: 130,
  }),
  ...
  L("6-05", 6, "Black Ice", {
    ...
    start: { minerals: 26, food: 10, crew: 4 },
    ice: [
      { x: 2, y: 6 },
      { x: 3, y: 6 },
      { x: 5, y: 6 },
