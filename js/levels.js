...
export const LEVELS = [
  ...
  L("2-02", 2, "Long Haul", {
    ...
    eatRate: 0.012,
    win: { mineral: 34, food: 10, rooms: { extractor: 1, kitchen: 1 } },
    par: 110,
  }),
  ...
  L("5-02", 5, "Island Core", {
    ...
    mechanics: { wormholes: true },
    allowed: ["corridor", "gate"],
    win: { food: 4, rooms: { gate: 2 }, folds: 1 },
    par: 70,
  }),
  ...
  L("5-05", 5, "Fragile Bridge", {
    ...
    relics: [{ x: 1, y: 1 }, { x: 7, y: 11 }],
    mechanics: { wormholes: true },
    allowed: ["corridor", "gate", "weapons"],
    waves: { first: 36, interval: 24, count: 4, hp: 36, max: 1 },
    win: { relics: 2, surviveWaves: 1 },
    par: 95,
  }),
  L("5-06", 5, "Folded War", {
