...
export const LEVELS = [
  ...
  L("2-05", 2, "Hungry Shift", {
    ...
    briefing: "You start with six kapsels and a thinning pantry. Stabilize food, then mint one more dash.",
  ...
  L("6-02", 6, "Thaw", {
    ...
    briefing: "Clear the frost. Place a hearth; once it is built it radiates without a babysitter.",
    hint: "The hearth thaws as soon as it is built.",
    start: { minerals: 10, food: 6, crew: 3 },
    ice: [
      { x: 3, y: 6 },
      { x: 5, y: 6 },
